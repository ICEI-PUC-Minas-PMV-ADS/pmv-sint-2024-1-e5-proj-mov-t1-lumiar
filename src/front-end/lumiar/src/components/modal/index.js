...
export function KidModal({ onClose, isVisible, item = {
  url: "https://blog-leiturinha-novo.s3.us-east-1.amazonaws.com/production/uploads/2022/07/iStock-1302266351-2-1.jpg",
  kidAge: '10',
  kidName: 'Lucas',
    ...
    <Modal
      ...
      <TouchableOpacity style={{
        ...
        <View style={styles.modalView}>
          ...
          <Text style={styles.kidAge}>{`${item.kidAge} anos`}</Text>
          ...
          <Text style={styles.kidText}>{item.kidText}</Text>
